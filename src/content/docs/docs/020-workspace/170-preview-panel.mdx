...
The Preview Panel contains an embedded browser frame that runs your animation using the Pixodesk Animator Studio runtime. It reflects the animation as it currently exists in the editor — including all keyframes, easing, loops, and object properties.
